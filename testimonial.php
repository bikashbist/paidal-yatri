                ...
                <section class="slider-part">
                    <div class="testimonial__part">
                        ...
                        <div class="testimonial__contain ">
                            <p class="text">Nostrud,
                                sapiente temporibus,
                                mus tenetur irure,
                                possimus auctor? Quos natus reiciendis phasellus ! Facilisi dicta lacus nulla,
                                vehicula iaculis ut cillum,
                                nec suscipit. Nihil reiciendis</p>
                            <h4>bikash bist</h4>
                        </div>
                    </div>
                    <div class="testimonial__part">
